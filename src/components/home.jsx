...
const allAvailableRegions = [
    { name: "서울특별시", description: "다채로운 매력의 도시", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "부산광역시", description: "열정적인 축제의 바다", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "대구광역시", description: "근대골목과 더위의 도시", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "인천광역시", description: "과거와 현재가 공존하는 항구도시", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "광주광역시", description: "예술과 민주화의 도시", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "대전광역시", description: "과학과 교통의 중심지", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "울산광역시", description: "산업과 자연의 조화", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "세종특별자치시", description: "행정 중심 복합도시", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "경기도", description: "역사와 미래가 함께하는 곳", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "강원특별자치도", description: "설렘 가득한 산과 바다", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "충청북도", description: "중원의 문화유산과 자연", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "충청남도", description: "백제의 숨결이 살아있는", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "전북특별자치도", description: "전통과 맛의 중심", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "전라남도", description: "맛과 멋의 고장", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "경상북도", description: "유구한 역사와 문화", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "경상남도", description: "역동적인 산업과 아름다운 자연", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
    { name: "제주특별자치도", description: "자연의 아름다움과 신비", image: `${process.env.PUBLIC_URL}/images/placeholder.png` },
];
            ...
            <div className="home-page-container vibrant-theme">
                ...
                <section className="home-section community-highlights-section">
                    ...
                    <div className="community-highlights-grid">
                        {communityHighlightsData.map(highlight => (
