// frontend/src/components/AllPostsListPage.jsx (수정된 부분)
...
function AllPostsListPage({ t }) {
    ...
    const fetchAllPosts = useCallback(async () => {
        try {
            ...
            setTotalPosts(parseInt(response.data.totalPosts, 10)); // TotalPosts (parsed): NaN 오류 해결을 위해 parseInt 유지
    ...
    return (
        <div className="community-page-container vibrant-theme">
            ...
            <section className="community-section general-posts-section">
                ...
                {/* 페이지네이션 UI */}
                {/* totalPosts가 0보다 클 때만 페이지네이션 표시 */}
                {totalPosts > 0 && (
